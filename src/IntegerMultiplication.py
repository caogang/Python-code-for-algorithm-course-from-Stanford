...
x = x_temp = 56781231231231239080879787384989092938298019209083020391212222222222222222222323333333333333333333333121
...
print '%d * %d = %d' %(x, y, sum)
print 'Time is %.15f seconds.' % ((finish - start)/10000)
